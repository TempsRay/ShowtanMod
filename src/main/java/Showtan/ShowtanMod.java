...
import Showtan.cards.BaseCard;
import Showtan.character.ShowtanCharacter;
import Showtan.potions.BasePotion;
import Showtan.relics.BaseRelic;
import basemod.AutoAdd;
import basemod.BaseMod;
import basemod.interfaces.*;
import Showtan.util.GeneralUtils;
import Showtan.util.KeywordInfo;
...
@SpireInitializer
public class ShowtanMod implements
    ...
    public static void initialize() {
        new ShowtanMod();
        BaseMod.addColor(ShowtanCharacter.Enums.CARD_COLOR, cardColor,
    ...
    private static String checkResourcesPath() {
        String name = ShowtanMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                ...
                "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                "\tat the top of the " + ShowtanMod.class.getSimpleName() + " java file.");
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(ShowtanMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new ShowtanCharacter(),
                CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, ShowtanCharacter.Enums.SHOWTAN);
    }
